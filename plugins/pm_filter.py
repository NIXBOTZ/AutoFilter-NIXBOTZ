...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("✧ ᴛᴀᴋᴇ ᴍᴏᴠɪᴇ ꜰʀᴏᴍ ʜᴇʀᴇ ✧", url=GRP_LNK)]])
    )
...
m=await message.reply_text("ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ <b>ʟɪsᴀ</b> ʙᴏᴛ")
        ...
        buttons = [[
            InlineKeyboardButton('☆ ᴀᴅᴍɪɴ ᴄᴏᴍᴍᴀɴᴅꜱ ☆', callback_data='admins')
        ], [
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ʀᴜʟᴇ', callback_data='rule')
        ], [
            InlineKeyboardButton('ʙɢ ʀᴇᴍᴏᴠᴇ', callback_data='bg_remove'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('wʀɪᴛᴇ', callback_data='write'), 
        ...
        buttons = [[
            InlineKeyboardButton('ᴘʜoɴᴇ', callback_data='phone'),
        ...
        buttons = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ', user_id=int(6899946963))
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('☎️ ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ', user_id=int(6899946963))
        ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            search = message.text
            m=await message.reply_text("🔎 sᴇᴀʀᴄʜɪɴɢ ғᴏʀ {search}") 
            await asyncio.sleep(0.4)
            await m.edit_text("ᴡᴀɪᴛ...")
            await asyncio.sleep(0.3)
            await m.edit_text("ᴜᴘʟoᴀᴅɪɴɢ...")
            await asyncio.sleep(0.3)
            await m.edit_text("🦋")
            await asyncio.sleep(0.5)
            await m.delete()  
...
async def advantage_spell_chok(client, msg):
    ...
    try:
        ...
        if not g_s:
            ...
            button = [[
                       InlineKeyboardButton("ʀᴇǫᴜᴇꜱᴛ ʜᴇʀᴇ ✅", url=f"https://t.me/NI__MOVIES__REQUEST")
            ]]
            if NO_RESULTS_MSG:

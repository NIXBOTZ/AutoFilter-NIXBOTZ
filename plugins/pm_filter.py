...
async def refercall(bot, query):
    btn = [[
        InlineKeyboardButton('ɪɴvɪᴛᴇ ʟɪɴᴋ 🔗', url=f'https://telegram.me/share/url?url=https://t.me/{bot.me.username}?start=reff_{query.from_user.id}&text=Hello%21%20Experience%20a%20bot%20that%20offers%20a%20vast%20library%20of%20unlimited%20movies%20and%20series.%20%F0%9F%98%83'),
        InlineKeyboardButton(f'⏳ {nixbotzreferdb.get_refer_points(query.from_user.id)}', callback_data='ref_point'),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # Don't change anything without contacting @IM_NISHANTT
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚡ soᴜʀcᴇ coᴅᴇ ⚡', callback_data='country_info')

...
from info import AUTH_CHANNEL, LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, SHORTLINK_URL, SHORTLINK_API, IS_SHORTLINK, LOG_CHANNEL, TUTORIAL, GRP_LNK, CHNL_LNK, CUSTOM_FILE_CAPTION, AUTH_USERS, VERIFY_SHORTLINK_URL, VERIFY_SHORTLINK_API, VERIFY_SECOND_SHORTNER, VERIFY_SND_SHORTLINK_URL, VERIFY_SND_SHORTLINK_API
...
import os
import time
from plugins.Extra import admin_check
                    ...
                    await bot.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                                ...
                                InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/IM_NISHANTT")
                                ]
                            ]
                        )
                    )
